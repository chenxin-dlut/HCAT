...
class ResNet(Backbone):
    ...
    def __init__(self, block, layers, output_layers, num_classes=1000, inplanes=64, dilation_factor=1, frozen_layers=()):
        ...
        self.layer3 = self._make_layer(block, inplanes*4, layers[2], stride=stride[1], dilation=max(dilation_factor//2, 1)) #stride 16
        # self.layer3 = self._make_layer(block, inplanes*4, layers[2], stride=1, dilation=2) #stride 8
