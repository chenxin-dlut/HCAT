...
from pysot_toolkit.trackers.tracker_onnx import Tracker
...
def main():
    ...
    # dataset_root = '/home/zxh/zxh/TransT_fix_nested/pysot_toolkit/testing_dataset/OTB'
    ...
    # net_path = '/home/zxh/zxh/TransT/models/model.pth'

    # create model
    # net = NetWithBackbone(net_path=net_path, use_gpu=True)
    backbone_path = '/home/kb/HCAT/pysot_toolkit/models/backbone_res18_N2_q16.onnx'
    model_path = '/home/kb/HCAT/pysot_toolkit/models/complete_res18_N2_q16.onnx'
